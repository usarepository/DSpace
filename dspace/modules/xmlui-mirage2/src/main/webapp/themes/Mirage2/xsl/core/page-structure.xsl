        ...
        <head>
            ...
            <link rel="shortcut icon">
                <xsl:attribute name="href">
                    ...
                    <xsl:text>images/usa-logo-32x32.png</xsl:text>
                </xsl:attribute>
            </link>
            <link rel="apple-touch-icon">
                <xsl:attribute name="href">
                    <xsl:value-of select="$theme-path"/>
                    <xsl:text>images/usa-logo-180x180.png</xsl:text>
                </xsl:attribute>
            </link>
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="{$context-path}/" class="navbar-brand">
                                <img src="{$theme-path}images/usa-logo.png"/>
                        </a>
                        </span>
                        <span class="headerInfoName">University of San Agustin</span>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-8">
                        <div class="hidden-print">
                            ...
                            <xsl:text>&#160;</xsl:text>
                            <a target="_blank" href="https://usa.edu.ph/about/services/lrc/">
                                <xsl:text>Learning Resource Center</xsl:text>
                            </a>
                            <xsl:text> | </xsl:text>
                            <a target="_blank" href="https://usa.edu.ph/">
                                <acronym title="University of San Agustin">
                                    <xsl:text>University of San Agustin</xsl:text>
                                </acronym>
                            </a>
                        </div>
                    </div>
